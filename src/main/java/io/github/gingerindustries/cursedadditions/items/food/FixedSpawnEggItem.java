...
public class FixedSpawnEggItem extends SpawnEggItem {
    protected static final List<FixedSpawnEggItem> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;
    private final EntityType<?> typeIn;

    public FixedSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, int primaryColorIn, int secondaryColorIn, Properties builder) {
    ...
    public FixedSpawnEggItem(EntityType<?> entityType, int primaryColorIn, int secondaryColorIn, Properties builder) {
